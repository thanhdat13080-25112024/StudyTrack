...
describe('gpa mirror — matches backend engine boundaries', () => {
  it.each([
    [10, 'A'], [8.5, 'A'], [8.4, 'B+'], [8.0, 'B+'], [7.9, 'B'], [7.0, 'B'],
    [6.9, 'C+'], [6.5, 'C+'], [6.4, 'C'], [5.5, 'C'], [5.4, 'D+'], [5.0, 'D+'],
    [4.9, 'D'], [4.0, 'D'], [3.9, 'F'], [0, 'F'],
  ...
  it.each([
    [4.0, 'xuat_sac'], [3.6, 'xuat_sac'], [3.59, 'gioi'], [3.2, 'gioi'], [3.19, 'kha'],
    [2.5, 'kha'], [2.49, 'trung_binh'], [2.0, 'trung_binh'], [1.99, 'yeu'], [0, 'yeu'],
